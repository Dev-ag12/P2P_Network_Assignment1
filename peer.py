...
file = open("C:/Users/lenovo/Downloads/networks_assi/config.txt","r")
SeedList=file.read()
# connect_seed_addr=SeedList
        ...
        try:
            ...
            if message:
                ...
                if message_type == "New Connect Request From":      
                    ...
                    liveness_reply = f"Live:{message_parts[1]}:{message_parts[2]}"+str(MY_IP)
